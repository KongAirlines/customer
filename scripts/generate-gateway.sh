...
readonly SERVICE="customer-information"
...
for stage in dev prod; do
  ...
  tags=("env-${stage}" "team-${TEAM}" "owner-${OWNER}" "scope-${SERVICE}-${stage}")
